...
public class OrderDomainServiceImpl implements OrderDomainService {
    ...
    @Override
    public OrderCancelledEvent cancelOrderPayment(Order order, List<String> failuresMessages, DomainEventPublisher<OrderCancelledEvent> orderCancelledEventDomainEventPublisher) {
        order.initCancel(failuresMessages);
