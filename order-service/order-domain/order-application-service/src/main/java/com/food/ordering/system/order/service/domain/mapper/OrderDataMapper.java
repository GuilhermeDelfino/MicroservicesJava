...
public class OrderDataMapper {
    ...
    public Order createOrderCommandToOrder(CreateOrderCommand createOrderCommand){
        return Order.Builder.builder()
                ...
                .items(orderItemToOrderItemsEntity(createOrderCommand.getItems()))
                .build();
    }

    private List<OrderItem> orderItemToOrderItemsEntity(List<com.food.ordering.system.order.service.domain.dto.create.OrderItem> orderItems) {
        return orderItems
                .stream()
                .map(orderItem ->
    ...
    public TrackOrderResponse orderToTrackOrderResponse(Order order){
        return TrackOrderResponse.builder()
                .orderTrackingId(order.getTrackingId().getValue())
                .orderStatus(order.getOrderStatus())
                .failuresMessages(order.getFailuresMessages())
                .build();
    }
}
