...
public class OrderController {
    ...
    public ResponseEntity<CreateOrderResponse> createOrder(@RequestBody CreateOrderCommand createOrderCommand){
        ...
        CreateOrderResponse createdOrderResponse = this.orderApplicationService.createOrder(createOrderCommand);
        log.info("Order created with tracking id: {}", createdOrderResponse.getOrderTrackingId());
