...
public class OrderDataAccessMapper {
    ...
    public OrderEntity orderToOrderEntity(Order order){
        OrderEntity orderEntity = OrderEntity
                ...
                .failuresMessages(order.getFailuresMessages() != null ? String.join(FAILURE_MESSAGE_DELIMITER, order.getFailuresMessages()) : "")
                .build();
    ...
    public Order orderEntityToOrder(OrderEntity orderEntity){
        return Order.Builder
                ...
                .failuresMessages(orderEntity.getFailuresMessages().isEmpty() ? new ArrayList<>() : new ArrayList<>(Arrays.asList(orderEntity.getFailuresMessages().split(FAILURE_MESSAGE_DELIMITER))))
