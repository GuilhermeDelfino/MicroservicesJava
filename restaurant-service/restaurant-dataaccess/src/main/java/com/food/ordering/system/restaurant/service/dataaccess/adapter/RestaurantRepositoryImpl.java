...
public class RestaurantRepositoryImpl implements RestaurantRepository {
    ...
    public Optional<Restaurant> findRestaurantInformation(Restaurant restaurant) {
        ...
        Optional<List<RestaurantEntity>> byRestaurantIdAndProductIdIn = restaurantJpaRepository.findByRestaurantIdAndProductIdIn(restaurant.getId().getValue(), restaurantProducts);
